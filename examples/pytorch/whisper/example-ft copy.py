...
from utils import WhisperForConditionalGeneration, WhisperDecoder, FTWhisperForConditionalGeneration
...
ft_model = FTWhisperForConditionalGeneration.from_pretrained("openai/whisper-tiny.en")
ft_model.cuda(1,5)
# %%
...
# %%
ft_whisper_config = ft_model.convert_config(1,5)# th.classes.FasterTransformer.FTWhisperConfig(
    # 1,
    # 51865,
    # 80,
    # 4,
